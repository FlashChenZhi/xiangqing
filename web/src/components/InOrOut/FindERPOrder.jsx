...
let OutputArea = React.createClass({
    ...
    getData(current){
        ...
        reqwest({
            url: '/wms/master/FindERPOrderAction/FindERPOrderData',
            dataType: 'json',
            method: 'post',
            data: {current:values.currentPage,defaultPageSize:defaultPageSize,orderNo:orderNo},
                        ...
                        <Col lg={12}>
                            ...
                            >
                                ...
                                <Input style={{width:"300"}}
                                       {...orderNoProps}   placeholder="请输入订单录入员" />
                            </FormItem>
