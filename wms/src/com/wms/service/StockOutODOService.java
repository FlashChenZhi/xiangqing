...
public class StockOutODOService {
    ...
    public ReturnObj<String> getOrderNo(){
        ...
        try {
            ...
            Query query = session.createQuery("select count(*) as count from RetrievalOrder r where CONVERT(Nvarchar, r.createDate, 111) = CONVERT(Nvarchar, GETDATE(), 111)  ");
    ...
    public ReturnObj<String> addOrder(String driver,String orderNo,
        ...
        try {
            ...
            if(retrievalOrder1==null && !orderNo.equals("dingdian")){
                long count2 = RetrievalOrder.getByStatus();
                if(count2==0){
